		...
		protected function setParams()
		{
			$this->params = array(
				...
				array(
					...
					'title' => esc_html__('Number of Columns', 'academist-lms'),
					'options' => array_flip(array(
						esc_html__('Default', 'academist-lms') => '',
						esc_html__('One', 'academist-lms') => 'one',
						esc_html__('Two', 'academist-lms') => 'two',
						esc_html__('Three', 'academist-lms') => 'three',
						esc_html__('Four', 'academist-lms') => 'four',
						esc_html__('Five', 'academist-lms') => 'five'
					)),
				...
				array(
					...
					'title' => esc_html__('Space Between Courses', 'academist-lms'),
