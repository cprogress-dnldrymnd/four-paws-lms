                    ...
                    <h3 class="eltdf-section-name">
                        ...
                        <?php if (isset($course_section['section_elements']) && $course_section['section_elements'] !== '') {
                            ...
                            if ( ! empty( $sectionElements ) ) {
	                            ...
	                            $completed_count = 0;
	                            foreach($lists['elements'] as $item){
	                            	foreach(academist_lms_user_current_course_items_completed(get_the_ID()) as $course){
	                            		if ($item['id'] === $course){
                                ...
                                ?>
                                <span class="eltdf-section-name-lessons"><?php echo esc_attr($completed_count) . "/" . esc_attr($number_of_elements); ?></span>
                                <?php
                            }
                        } ?>
                    </h3>
