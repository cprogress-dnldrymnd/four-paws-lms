<?php if ( $filter == 'different-view' ) { ?>
	<div class="eltdf-cl-filter-holder">
		...
		<div class="eltdf-course-items-counter">
			<span class="counter-label"><?php esc_html_e( 'Showing', 'academist-lms' ); ?></span>
			...
			<span class="counter-label"><?php esc_html_e( 'of', 'academist-lms' ); ?></span>
		...
		<div class="eltdf-course-items-order">
			<select class="eltdf-course-order-filter">
				...
				<option data-type="date" data-order="DESC"><?php esc_html_e( 'Newly Published', 'academist-lms' ); ?></option>
				<option data-type="name" data-order="ASC"><?php esc_html_e( 'A-Z', 'academist-lms' ); ?></option>
				<option data-type="name" data-order="DESC"><?php esc_html_e( 'Z-A', 'academist-lms' ); ?></option>
			</select>
		</div>
	</div>
<?php } ?>